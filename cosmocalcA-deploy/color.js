...
/* ---- Universal Pendulum 400-grade scale -------------------------
   The White -> Black arc (South, 0/400g) with the Greek-letter
   ...
   UP grade convention (per Clea): 0g = South, 100g = West,
   200g = North, 300g = East. So grade = angle*10/9 + 100 (mod 400),
   because the angle scale starts at West (0°) while the grade scale
   starts at South (0g). */
...
const PENDULUM_24COLOR = [
  { degree: 0,   grade: 100,    name: 'Red' },
  { degree: 15,  grade: 116.67, name: 'Red-Orange' },
  { degree: 30,  grade: 133.33, name: 'Orange' },
  { degree: 45,  grade: 150,    name: 'Orange-Yellow' },
  { degree: 60,  grade: 166.67, name: 'Yellow' },
  { degree: 75,  grade: 183.33, name: 'Yellow-Green' },
  { degree: 90,  grade: 200,    name: 'Green' },
  { degree: 105, grade: 216.67, name: 'Turquoise' },
  { degree: 120, grade: 233.33, name: 'Blue' },
  { degree: 135, grade: 250,    name: 'Blue-Indigo' },
  { degree: 150, grade: 266.67, name: 'Indigo' },
  { degree: 165, grade: 283.33, name: 'Indigo-Violet' },
  { degree: 180, grade: 300,    name: 'Violet' },
  { degree: 195, grade: 316.67, name: 'Violet-UV' },
  { degree: 210, grade: 333.33, name: 'Ultra-Violet' },
  { degree: 225, grade: 350,    name: 'UV-White' },
  { degree: 240, grade: 366.67, name: 'White' },
  { degree: 255, grade: 383.33, name: 'White-Grey' },
  { degree: 270, grade: 400,    name: 'Negative Green' },
  { degree: 285, grade: 16.67,  name: 'Grey-Black' },
  { degree: 300, grade: 33.33,  name: 'Black' },
  { degree: 315, grade: 50,     name: 'Black-IR' },
  { degree: 330, grade: 66.67,  name: 'Infra-Red' },
  { degree: 345, grade: 83.33,  name: 'IR-Red' }
];

/* Pi-ray: special ray 6°15' (6.25°) from Negative Green/Omega toward
   Black, i.e. 276.25° (6.94g) in the 24-color wheel. */
const PENDULUM_PIRAY = { degree: 276.25, grade: 6.94, name: 'Pi-ray' };

function gradeFromAngle(angle) {
  // UP grade convention: 0g = South, 100g = West, 200g = North, 300g = East.
  // Angle scale starts at West (0°), so add 100 grades to align.
  return ((angle * 10 / 9 + 100) % 400 + 400) % 400;
}
